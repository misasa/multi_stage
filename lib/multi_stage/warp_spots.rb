...
SEE ALSO
    vs-warp-spots-1270 in [gem package -- vstool](https://github.com/misasa/vstool)
    ...
    vs2cha
    cha2vs
    https://github.com/misasa/multi_stage
    https://github.com/misasa/multi_stage/blob/master/lib/multi_stage/warp_spots.rb
